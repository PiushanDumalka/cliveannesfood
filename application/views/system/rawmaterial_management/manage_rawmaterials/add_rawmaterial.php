    ...
    <body class="hold-transition skin-blue fixed sidebar-mini">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <?php echo form_open_multipart('', ['id' => 'add_rawmaterial_form']); ?>
                                                <div class="col-md-9">
                                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-sm-6"><span style="color:Red;">*</span>
                                                            ...
                                                            <input class="form-control" name="rawmaterialname" id="rawmaterialname" type="text" maxlength="65" required/>
                                                        ...
                                                        <div class="form-group col-sm-6">
                                                            ...
                                                            <select class="form-control" name="rawmaterialcategory" id="rawmaterialcategory">
                                                                ...
                                                                <option value="2">Packing Material</option>
                                                            </select>                                                    
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 buttons">
                                                        <div class="col-md-1 col-sm-2">
                                                            <div class="form_sep">
                                                                <input class="btn btn-warning" id="add_rawmaterial_submit" type="submit" name="add_rawmaterial_submit" value="Submit" />    
                                                            </div>
                                                        </div>
                                                        <div class="col-md-1 col-sm-2">
                                                            <div class="form_sep">
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                /**Form Validation**/
                $(document).on('click', "#add_rawmaterial_submit", function (e) {
