    ...
    <body class="hold-transition skin-blue fixed sidebar-mini">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <?php echo form_open_multipart('', ['id' => 'edit_usertype_form']); ?>
                                                    <div class="row">
                                                        <p><b>USERTYPE DETAILS:-</b></p><hr>
                                                        <div class="form-group col-sm-8"><span style="color:Red;">*</span>
                                                            <label class="req">Type </label>
                                                            <input class="form-control" name="usertype" id="usertype" type="text" maxlength="45" required value="<?php if ($get_usertype->num_rows() > 0) { ?><?php echo $get_usertype->row()->Type; ?><?php } ?>"/>
                                                    ...
                                                    <div class="row buttons">
                                                        <div class="col-sm-2">
                                                            <div class="form_sep">
                                                                <input class="btn btn-warning" id="edit_usertype_submit" type="submit" name="edit_usertype_submit" value="Update" />    
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <div class="form_sep">
        ...
        <script>
            $(document).ready(function () {
                ...
                /**Form Validation**/
                $(document).on('click', "#edit_usertype_submit", function (e) {
