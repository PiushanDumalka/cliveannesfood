    ...
    <body class="hold-transition skin-blue fixed sidebar-mini">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"> 
                                        <button type="button" class="btn btn-danger" id="user_view"  name="view_user" onclick="location.href = '<?php echo base_url(); ?>usertyperole/view_usertyperoles';"><i class="fa fa-list"></i> View Roles</button> 
                                    </h4>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <?php echo form_open_multipart('', ['id' => 'edit_usertyperole_form']); ?>
                                                <div class="row">
                                                    <p><b>Edit Assign Roles</b></p><hr>
                                                    <div class="form-group col-sm-4">
                                                        <label for="reg_input_usertype">User Type</label><span style="color:Red;">*</span>
                                                        <select class="form-control" name="usertype" id="usertype"  disabled="true">
                                                            <option value="">Select User Type</option>
                                                            <?php
                                                            if ($get_usertype->num_rows() > 0) {
                                                                foreach ($get_usertype->result() as $usertype) {
                                                                    ?>
                                                                    <option value="<?php echo $usertype->Id ?>" <?php echo ($usertype->Id == $get_usertyperole->row()->TypeId) ? 'selected="selected"' : '' ?>> <?php echo $usertype->Type ?></option>;
                                                                    <?php
                                                                }
                                                            }
                                                            ?>
                                                        ...
                                                        <select class="form-control" id="role" name="role[]" multiple="multiple" value="Please select Roles">
                                                            ...
                                                            if ($get_userrole->num_rows() > 0) {
                                                                foreach ($get_userrole->result() as $role) {
                                                                    ?>
                                                                    <option value='<?php echo $role->Id ?>' <?php echo ($role->Id == $get_usertyperole->row()->RoleId) ? 'selected="selected" Disabled="true"' : '' ?>> <?php echo $role->RoleName ?></option>
                                                                    <?php
                                                                }
                                                            }
                                                            ?>
                                                ...
                                                <div class="row buttons">
                                                    <div class="col-sm-1">
                                                        <div class="form_sep">
                                                            <input class="btn btn-warning" id="edit_usertyperole_submit" type="submit" name="edit_usertyperole_submit" value="Update" />    
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-1">
                                                        <div class="form_sep">
                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <table id="userrole_table" class="table table-striped table-bordered" style="width:100%">
                                                            <thead>
                                                                <tr>
                                                                    <th>User Type</th>
                                                                    <th>User Roles</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                if ($get_usertyperole->num_rows() > 0) {
                                                                    foreach ($get_usertyperole->result() as $usertyperole) {
                                                                        ?>
                                                                        <tr>
                                                                            <td><?php echo $usertyperole->Type; ?></td>
                                                                            <td><?php echo $usertyperole->RoleName; ?></td>
                                                                            <td><button type="button" class="btn btn-link delete" id="<?php echo $usertyperole->TypeId; ?>/<?php echo $usertyperole->RoleId; ?>"><i class="fa fa-trash"></i> Delete</button></td>
                                                                        </tr>
                                                                        <?php
                                                                    }
                                                                }
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#userrole_table .UserTypeCell').each(function ()
                {
                    alert($(this).html());
                });

                /**Form Validation**/
                $(document).on('click', "#edit_usertyperole_submit", function (e) {
                    e.preventDefault();
                    $(".alert").hide();
                    if ($('#usertype').val() == 0) {
                        $("#usertype_error").show();
                ...
                $(document).on('click', ".delete", function (e) {
                    ...
                    swal({
                        ...
                        dangerMode: true,
                            ...
                            .then((willDelete) => {
                                if (willDelete) {
                                    document.location.href = '<?php echo base_url(); ?>usertyperole/delete_usertyperole/' + id;
                                } else {
                                    swal("Not Deleted!");
                                }
                            });
