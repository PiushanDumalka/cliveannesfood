    ...
    <body class="hold-transition skin-blue fixed sidebar-mini">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <?php echo form_open_multipart('', ['id' => 'edit_designation_form']); ?>
                                                    <div class="row">
                                                        <p><b>DESIGNATION DETAILS:-</b></p><hr>
                                                        <div class="form-group col-sm-8"><span style="color:Red;">*</span>
                                                            <label class="req">Designation </label>
                                                            <input class="form-control" name="designation" id="designation" type="text" maxlength="45" required value="<?php if ($get_designation->num_rows() > 0) { ?><?php echo $get_designation->row()->Designation; ?><?php } ?>"/>
                                                    ...
                                                    <div class="row buttons">
                                                        <div class="col-sm-2">
                                                            <div class="form_sep">
                                                                <input class="btn btn-warning" id="edit_designation_submit" type="submit" name="edit_designation_submit" value="Update" />    
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <div class="form_sep">
        ...
        <script>
            $(document).ready(function () {
                ...
                /**Form Validation**/
                $(document).on('click', "#edit_designation_submit", function (e) {
