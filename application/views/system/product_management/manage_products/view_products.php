                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"> 
                                        ...
                                        <button type="button" class="btn btn-link pull-right" id="out_product"  name="out_product" onclick="location.href = '<?php echo base_url(); ?>product/outofstock_products';" data-toggle="tooltip" title="Inactive products"><i class="fa fa-trash"></i></button> 
                                    </h4>
                                </div>
