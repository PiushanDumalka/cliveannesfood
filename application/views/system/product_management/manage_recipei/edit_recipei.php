                                        ...
                                        <div class="panel-body">
                                            ...
                                            if ($get_product->num_rows() > 0) {
                                                ...
                                                <div class="row">
                                                    ...
                                                    <?php echo form_open_multipart('', ['id' => 'edit_product_form']); ?>
                                                    <div class="col-md-9">
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-sm-6"><span style="color:Red;">*</span>
                                                                ...
                                                                <input class="form-control" name="productname" id="productname" type="text" maxlength="65" required value="<?php echo $get_product->row()->ProductName; ?>"/>
                                                                ...
                                                                <select class="form-control" name="productcategory" id="productcategory">
                                                                    ...
                                                                    if ($get_productcategory->num_rows() > 0) {
                                                                        foreach ($get_productcategory->result() as $productcategory) {
                                                                            ?>
                                                                            <option value="<?php echo $productcategory->Id; ?>" <?php echo ($productcategory->Id == $get_product->row()->ProductCategory) ? 'selected="selected"' : '' ?>><?php echo $productcategory->CategoryName; ?></option>
                                                                            <?php
                                                                        }
                                                                    }
                                                                    ?>
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <select class="form-control" name="weight" id="weight" required>
                                                                    ...
                                                                    if ($get_weight->num_rows() > 0) {
                                                                        foreach ($get_weight->result() as $weight) {
                                                                            ?>
                                                                            <option value="<?php echo $weight->Id ?>"  <?php echo ($weight->Id == $get_product->row()->WeightId) ? 'selected="selected"' : '' ?>><?php echo $weight->Weight.$weight->Unit; ?></option>;
                                                                            <?php
                                                                        }
                                                                    }
                                                                    ?>
                                                            ...
                                                            <div class="form-group col-sm-6"><span style="color:Red;">*</span>
                                                                ...
                                                                <input class="form-control" name="expireduration" id="expireduration" type="text" maxlength="65" value="<?php echo $get_product->row()->ExpPeriod; ?>" required/>
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-sm-6">
                                                                ...
                                                                <select class="form-control" name="availability" id="availability" required>
                                                                    <option value='1'  <?php echo (1 == $get_product->row()->Status) ? 'selected="selected"' : '' ?>>Active</option>;
                                                                    <option value='0' <?php echo (0 == $get_product->row()->Status) ? 'selected="selected"' : '' ?>>Inactive</option>;
                                                                </select>
                                                            ...
                                                            <div class="form-group col-sm-6">
                                                                ...
                                                                <input class="form-control" name="remark" id="remark" type="text" maxlength="65" value="<?php echo $get_product->row()->Remark; ?>" required/>
                                                            </div>
                                                        </div> 
                                                    </div>
                                                    <div class="col-md-3">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <div class="avatar-upload">
                                                                    <div class="avatar-edit">
                                                                        <input type="hidden" id="productphotoold" name="productphotoold" value="<?php echo $get_product->row()->PhotoName ?>">
                                                                    ...
                                                                    <div class="avatar-preview">
                                                                        <?php if ($get_product->row()->PhotoName) { ?>
                                                                            <div id="imagePreview" style="background-image: url(<?php echo base_url(); ?>uploads/products/<?php echo $get_product->row()->PhotoName; ?>);"></div>
                                                                        <?php } else { ?>
                                                                            <div id="imagePreview" style="background-image: url(<?php echo base_url(); ?>assets/system/img/no-product-img.jpg);"></div>
                                                                        <?php } ?>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 buttons">
                                                            <div class="col-md-1 col-sm-2">
                                                                <div class="form_sep">
                                                                    <input class="btn btn-warning" id="edit_product_submit" type="submit" name="edit_product_submit" value="Update" />    
                                                                </div>
                                                            </div>
                                                            <div class="col-md-1 col-sm-2">
                                                                <div class="form_sep">
                ...
                function readURL(input) {
                    if (input.files && input.files[0]) {
                        ...
                        if ($.inArray($(input).val().split('.').pop().toLowerCase(), fileExtension) == -1) {
                            ...
                            $('#imagePreview').css('background-image', 'url(<?php echo base_url(); ?>uploads/products/<?php echo $get_product->row()->PhotoName; ?>)');
