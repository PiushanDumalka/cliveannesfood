...
<header class="main-header">
    <!-- Logo -->
    <a href="" class="logo"><img style="width:45%;" src="<?php echo base_url(); ?>assets/system/img/logo.png"/></a>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <a href="<?php echo base_url(); ?>index.php/login/logouthandle" class="btn btn-default btn-flat">Sign out</a>
                            </div>
                        </li>
                    </ul>
                </li>
