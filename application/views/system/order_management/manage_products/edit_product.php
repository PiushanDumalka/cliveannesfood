                                                                ...
                                                                <select class="form-control" name="weight" id="weight" required>
                                                                    ...
                                                                    if ($get_weight->num_rows() > 0) {
                                                                        foreach ($get_weight->result() as $weight) {
                                                                            ?>
                                                                            <option value="<?php echo $weight->Id ?>"  <?php echo ($weight->Id == $get_product->row()->WeightId) ? 'selected="selected"' : '' ?>><?php echo $weight->Weight; ?></option>;
                                                                            <?php
                                                                        }
                                                                    }
                                                                    ?>
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-sm-6">
                                                                ...
                                                                <select class="form-control" name="availability" id="availability" required>
                                                                    <option value='1'  <?php echo (1 == $get_product->row()->Status) ? 'selected="selected"' : '' ?>>In Stock</option>;
                                                                    <option value='0' <?php echo (0 == $get_product->row()->Status) ? 'selected="selected"' : '' ?>>Out Of Stock</option>;
                                                                </select>
