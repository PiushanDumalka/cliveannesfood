                                        ...
                                        if ($get_product->num_rows() > 0) {
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-sm-6">
                                                        <input class="form-control" name="consumerprice" id="consumerprice" type="text" maxlength="10" value="<?php echo $get_product->row()->ConsumerPrice; ?>" required/>
                                                    </div> 
                                                    <div class="form-group col-sm-12">
            ...
            $(document).ready(function () {
                ...
                $(document).on('click', "#add_price_submit", function (e) {
                    ...
                    if (!(/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:[\.,]\d+)?$/.test($('input#unitprice').val())) || $('input#unitprice').val() == '' || $('input#unitprice').val().trim() == "") {
                        ...
                        $("#retailerprice").focus();
                    } else if (!(/^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:[\.,]\d+)?$/.test($('input#consumerprice').val())) || $('#consumerprice').val() == '' || $('#consumerprice').val().trim() == "") {
                        $("#consumerprice_error").show();
                        $("#consumerprice").focus();
                    } else {
